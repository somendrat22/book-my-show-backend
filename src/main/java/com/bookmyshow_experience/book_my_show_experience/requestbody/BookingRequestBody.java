...
public class BookingRequestBody {
    ...
    public BookingRequestBody(String userName, String userEmail, int totalTickets, int totalAmountPaid, String paymentMethod, String hallName, String theaterName, String theaterAddress) {
